...
public class StreamProgram {
    ...
    public static void main(String[] args) {
        ...
        List<Student> studentList = studentsMock.stream().filter(student -> student.percentage<55).collect(Collectors.toList());
        ...
        List<Student> sortedStudents= studentsMock.stream().sorted((student1, student2) -> student1.percentage < student2.percentage ? 1 : -1).collect(Collectors.toList());
        sortedStudents.forEach(System.out::println);

        System.out.println("________________LOWEST PERCENTAGE STUDENT_______________");
       Student lowestPercentageStudent= studentsMock.stream().min((student1, student2) -> student1.percentage > student2.percentage ? 1 : -1).get();
        ...
        boolean isFailedStudent=studentsMock.stream().noneMatch(student -> student.percentage < 40);
        Predicate<Student> passedWithDistinction = student -> student.percentage >= 80;
